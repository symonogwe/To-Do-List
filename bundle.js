...
function getFinishTask(e) {
    ...
    completedDiv.push(_dom_js__WEBPACK_IMPORTED_MODULE_0__.targetObject.taskArray[completedDivIndex]);
...
function deleteTask(e) {
    ...
    _dom_js__WEBPACK_IMPORTED_MODULE_0__.targetObject.taskArray.splice(targetIndex, 1);
    (0,_dom_js__WEBPACK_IMPORTED_MODULE_0__.createProjectTasks)();
}
...
function createProjectDiv() {
    ...
    if (projectDiv.innerHTML === "" && (0,_localeStorage_js__WEBPACK_IMPORTED_MODULE_4__.getProjectArray)().length !== 0) {
        ...
        projectP.textContent = (0,_localeStorage_js__WEBPACK_IMPORTED_MODULE_4__.getProjectArray)()[0].name;
...
function createProjectTasks() {
    ...
    if ((0,_localeStorage_js__WEBPACK_IMPORTED_MODULE_4__.getProjectArray)()[targetIndex].taskArray.length !== 0) {
        (0,_localeStorage_js__WEBPACK_IMPORTED_MODULE_4__.getProjectArray)()[targetIndex].taskArray.forEach(task => {
            // task div
            ...
            _deleteDom_js__WEBPACK_IMPORTED_MODULE_2__.completedDiv.forEach(div => {
                if (div === task) {
...
/* harmony export */   modifyProjectArray: () => (/* binding */ modifyProjectArray)
/* harmony export */ });
...
function createTask() {
    ...
    console.log((0,_localeStorage_js__WEBPACK_IMPORTED_MODULE_2__.getProjectArray)()[_dom_js__WEBPACK_IMPORTED_MODULE_0__.targetIndex]);
